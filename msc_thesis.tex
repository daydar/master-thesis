...
In dieser Abbildung sind die persöhnliche Daten des Auftrags verpixelt und damit anonymisiert.
...
in mehreren Zeileneinträgen Überläufe bei den Arbeitnummern bzw. den Teilenummern zu erkennen.
...
Ein solches wissenbasiertes System ist hierbei der Oberbegriff für Programme, die mit Hilfe einer Wissensbasis Mechanismen der Schlussfolgerung nutzen, 
um Lösungen für Probleme zu finden~\cite{embreySkillRuleKnowledge}. 
Es existieren verschiedene Modelle eines wissenbasiertes Systems, die sich, je nach Anwendungsfall, als passend erweisen.
So gibt es den Ansatz des regelbasierten Systems, bei dem die Schlussfolgerung über Regeln und Fakten, 
die von einem Benutzer definiert werden, gestaltet wird.
Bekannt für die Erstellung eines solchen Systems ist CLIPS\cite{clipsCLIPSToolBuilding}, welches über eine eigene Syntax erlaubt, 

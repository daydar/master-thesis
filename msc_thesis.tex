...
mit solchen die Mitarbeiter ihr Prozesse abwickeln, aus. Der daraus resultierende Arbeitsaufwand, 
...
womit das System einen Zustand der Instandhaltung annehmen kann. 
...
Zunächst einmal wird der Kontext ausführlicher erklärt.
...
die nur über Scanner die Dokumente übertragen. 
...
Idealerweise soll dies genutzt werden, um aus den Dokumenten Arbeitsaufträge zu generieren und somit zu digitalisieren.
Somit bietet sich hier an der Stelle die Möglichkeit einen neuen Ansatz auszuprobieren, um die Informationen 
aus diesen Dokumenten als Daten zu erhalten.
...
Bei den Dokumenten, die in das ERP-System eingescannt werden, handelt es sich in der Mehrheit um Garantieaufträge und Rechnungen. 
Jedes Autohaus benutzt hierbei ein individuelles Dokumentenmuster.
Dem Umfang dieser Thesis geschuldet werde ich mich auf drei Dokumententypen beschränken und anhand jener drei Typen mein Vorgehen 
exemplarisch demonstrieren.

In Abbildung ??? wird die erste Art eines Auftrags dargestellt.

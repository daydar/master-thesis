...
So nutzen Produkte wie Textractor \cite{amazon_intelligente_nodate} von AWS oder Adobes Extractor API \cite{developers_extract_nodate} Künstliche Intelligenz, 
Machine Learning und Optical Character Recognition (OCR) um die Extraktion der Daten zu ermöglichen. 
Unternehmen wie ABBYY \cite{abbyy_pdf_nodate} habe sich bereits auf diesem Gebiet spezialisiert und sind erfolgreich mit der Datenextraktion. 

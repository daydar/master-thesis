...
Für alle beschriebene Ziele existieren mindestens die Positionierung als Eigenschaft.
Dies kann als Bounding Box (bbox) mit den X und Y Koordinaten für die jeweiligen Extraktionsziele aufgeführt werden.
Eine weitere Eigenschaft, die sich aus der Positionierung schließen lässt, ist die Dokumentseite. 
Dies kann den Funktionen neben den Bounding Boxen als Seitennummer mitgegeben werden.

Die Klassen der einzelnen Dokumentarten dienen für weitere Funktionalitäten, die spezifischere Zwecke für den jeweiligen Dokumenttyp erfüllen 
und eine Semantik für die extrahierten Texte bilden.
Diese Methoden erhalten mit Hilfe von regulären Ausdrücken die einzelnen Werte für die gewünschten Felder 
und weisen diese mit ähnlichen Algorithmen den Feldern zu.

\subsection{Regelsyntax}

Die Texte können nun durch den Extraktionsvorgang erhalten werden.

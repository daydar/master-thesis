...
sodass danach ein generatives Modell angelernt ist. hsd
...
über einen sinnvollen Anwendungsbereich für das von den Mitarbeiter:innen genutzte ERP-System verfügt.
Des Weiteren ist aufgefallen, dass die Dokumente, auf die sich im Rahmen der Thesis eingeschränkt wurden, 
viele verschiedene Formen besitzen beziehungsweise haben können.
Die Unterschiede liegen bei der Mehrheit in den Details der einzelnen Extraktionsbereiche.
...
womit der Durchstich der Funktionalitäten ermöglicht.
Ein Dokument 
Für die Umsetzung des Machine-Learning Ansatzes erwiesen sich der Ansatz 
des schwachen maschinellen Lernens als vielversprechende Alternative 
...
Für das Teilsystem der symbolischen KI werden die 

...
oder Software as a Service (SaaS) Plattformen zu beschaffen. 
...
wodurch die Daten nach und nach beschafft werden~\cite{stichdataWhatDataExtraction}.
...
Da die Teilsysteme wiederum eigene Systeme darstellen können und für die Anwendungsfälle kommunizieren beziehungsweise interagieren müssen, 
scheint hier der Ansatz der verteilten Systeme geeignet zu sein.
...
Damit dieser Netzwerkansatz für die Architektur umgesetzt werden kann, ist die Benutzung eines Webservers notwendig. 

...
eignen sich sowohl Benutzerschnittstellen bzw. User Interface (UI) Bibliotheken für den Desktop als auch für den Webbereich.
Die Priorität liegt hierbei bei der Erstellung der einzelnen Komponenten der graphische Benutzeroberfläche bzw.\ der Graphical User Interface (GUI). 
...
\subsection{Syntax und Grammatik der Regeln}
...
Regelbasierte Systeme wie CLIPS nutzen, wie bereits beschrieben, eine eigene Syntax, die auf der Programmiersprache Lisp basiert.

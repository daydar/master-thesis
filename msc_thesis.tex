...
Dieses System soll dabei Ansätze aus der künstlichen Intelligenz nutzen und 
eine grafische Schnittstelle für die Benutzer des Systems anbieten.
...
Die Tabelle ist an der Kopfzeile zu erkennen, welche die Jobs und Joblines in den Arbeitswert beziehungsweise in die Teilenummer, 
in der Bezeichnung, in die Menge des Arbeitswertes, in den Preis und in den Betrag übersichtlich aufteilt.
...
in mehreren Zeileneinträgen Überläufe bei den Arbeitswerten bzw. den Teilenummern zu erkennen.
...
Dies ist durch die Codierung der Arbeitswerte bzw. der Teilenummer zu erkennen 
...
Die Gesamtkosten werden dann am Ende des Dokuments in den Teilsummen der Beträge. 

...
\subsection{Syntax und Grammatik der Fakten und Regeln}
...
Die Fakten werden dies als eine Menge der zu extrahierenden Objekte definiert.
...
welche nach der Namenskonvention in Python beliebig benannt werden können.
...
in der Erweiterten Backus-Naur-Form (EBNF) erlaubt und basierend auf dieser abstrakte Syntaxbäume aus Texteingaben generiert~\cite{lark-parserLarkparserLarkLark}.
...
Abbildung ... zeigt ein Beispiel wie somit aus einem Regelausdruck ein Syntaxbaum durch den Parser kreiert werden kann.
...
\subsection{Regelmaschine}

Nachdem nun die Syntax und Grammatik der Regeln gegeben ist, wird die Regelmaschine als Modul entwickelt.
Dieses Modul bildet sich aus den Klassen für den Regelinterpreter und den Regelspeicher.
...
Zur Speicherung der Regeln und Fakten kann dies über den persistenten Ansatz der Datenbanken ermöglicht werden.
...
Hierfür werden durch eine Funktionalität die Fakten als eine Liste von Tupeln erzeugt, 
die den Pfad zur Eigenschaft in der Punktnotation beinhaltet.

...
\begin{figure}[htb]
    ...
    \frame{\includegraphics[width=.45\textwidth]{images/kfz3000_werkstattauftrag_raw.png}}}
    \subfloat[mit visuellem Debugging]{\label{fig:wvd}
    \frame{\includegraphics[width=.45\textwidth]{images/kfz3000_werkstattauftrag_vd.png}}}    
...
Hierbei werden für die Teilsysteme verschiedene Technologien sich angeschaut in Erwägung gezogen. 
So wird zunächst das erste Teilsystem für die symbolische Künstliche Intelligenz abgedeckt und es 
Zunächst muss ein Modell der symbolischen KI ausgewählt werden aus den verschiedenen Arten eines Expertensystems.

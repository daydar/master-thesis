...
In Kapitel~\ref{sec:frameworks} wurde ersichtlich, dass es viele Frameworks gibt, die ein solches System bereitstellen können.
...
Die vorgestellten Bibliotheken verursachen einen größeren Aufwand, welche weitere Abhängigkeiten mit sich bringen 
...
Dies kann als Bounding Box (bbox) mit den X und Y Koordinaten für die jeweiligen Extraktionsziele aufgeführt werden.
...
So werden je nach Dokumentenart die Daten mit
...
Regelbasierte Systeme wie CLIPS nutzen, wie bereits beschrieben, eine eigene Syntax, die sich

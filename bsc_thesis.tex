...
Dokumenten oder Belege arbeiten müssen. Unter dieser Vielzahl fallen Dokumente wie Werkstatt-, Kauf- und Mietverträge 
...
wodurch die Daten zugänglicher aber immer noch verarbeitet werden müssen, was den ganzen Vorgang als eine Notlösung wirken lässt.
...
Mit dem derzeitigen Stand der Datenextraktion können lediglich Agierende aus dem technischen Bereich arbeiten. 
...
Eine solche Eigenschaft kann durch eine symbolische KI abgedeckt werden, welche eine vorgegebene Verarbeitung möglich macht. 
Mit Hilfe einer Parametrisierung kann die Unschärfe der ausgewählten Daten festgelegt werden, 
damit eine Feineinstellung stattfinden kann. 
Mit Hilfe von Definitionen der Unschärfe kann so für eine bessere Erfolgsquote gesorgt werden. 
Zudem kann der Ansatz des Machine Learnings, wobei erfolgreiche Verarbeitungen einem System antrainiert werden, 
weitere Dokumente aus Daten extrahieren. 

Beide Ansätze – der der symbolischen KI und der des Machine Learnings – bieten die Option für die Entwicklung einer grafischen Entwicklungsumgebung (IDE). 
Jene soll Definitionen festlegen, mit welchen die Dokumente verarbeitet werden können. 
Durch diese Festlegung soll dann eine Vorschau des bisherigen Ergebnisses angezeigt werden. 

\section{Ablauf}

Um genau diese optimale Anwendung (ist es das, was du schreibst?) entwickeln zu können, 
werde ich in dieser Arbeit wie folgt vorgehen: 
...
um die vorhandenen Grundlagen für den Anwendungsfall zu evaluieren. 
...
für die Entwicklung eingerichtet werden womit die Implementierung der Systeme stattfinden soll. 
Danach soll sich der Konzeptionierung und Entwicklung der symbolischen KI gewidmet werden, 
womit ein direkterer Ansatz ermöglicht werden soll.

\chapter{Hintergrund}\label{chap:hint}

Um die Problematik darzustellen und um eine Übersicht zu ermöglichen, 
